              ...
              <div class="box-body">
                <form action="/disciplina/posts/atualiza" method="post">
                  ...
                  <div class="form-group">
                    <label>Titulo</label>
                    <input name="titulo" class="form-control pull-right" value = "{{$post->titulo}}">
                  </div>

                  <div class="form-group">
                    <label>Descricao</label>
                    <textarea rows="4" cols="40"  name="descricao" class="form-control" value = "{{$post->descricao}}"/></textarea>
                  </div>
