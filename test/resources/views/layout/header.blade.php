...
<header class="main-header ">
  ...
  <!-- Logo -->
  <a href="index2.html" class="logo"><b> AVA</b></a>
          ...
          <ul class="nav navbar-nav">
                      ...
                      <li>
                          ...
                          <ul class="menu">
                              <li><!-- start notification -->
                                  <a href="#">
                                      <i class="fa fa-users text-aqua"></i> 5 novos membros hoje
                                  </a>
                              </li><!-- end notification -->
                          </ul>
                      </li>
              ...
              <li class="dropdown user user-menu">
                  ...
                  <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                      ...
                      <span class="hidden-xs">Seu nome aqui</span>
                  </a>
                  <ul class="dropdown-menu">
                      ...
                      <li class="user-footer">
                          <div class="pull-left">
                              <a href="#" class="btn btn-default btn-flat">Atulizar  conta</a>
                          </div>
              ...
              <li>
                  <img src="{{ asset("/bower_components/admin-lte/dist/img/ifms.png") }}" width="25px"/>
              </li>
          </ul>
      </div>
  </nav>
